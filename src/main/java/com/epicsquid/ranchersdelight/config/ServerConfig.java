...
public class ServerConfig {
	...
	public final ForgeConfigSpec.ConfigValue<Integer> TRUFFLE_SPAWN_DELAY;
	...
	public ServerConfig(ForgeConfigSpec.Builder builder) {
		...
		FEATHER_SPAWN_DELAY = builder.comment("The max bound of the random amount of time before a feather will spawn from a chicken.")
				.define("feather_spawn_delay", 8000);
		RABBIT_WOOL_SPAWN_DELAY = builder.comment("The max bound of the random amount of time before a rabbit wool will spawn from a rabbit.")
				.define("rabbit_wool_spawn_delay", 8000);
		...
		TRUFFLE_SPAWN_DELAY = builder.comment("The max bound of the random amount of time before a truffle will spawn from a pig.")
				.define("truffle_spawn_delay", 10000);
		builder.pop();
	}
}
